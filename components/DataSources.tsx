    ...
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-slide-up">
      ...
      <div className="p-4 md:p-6 space-y-3">
        <Link
          ...
          className="group flex items-center justify-between gap-4 p-4 md:p-5 bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-100 rounded-xl hover:border-green-300 hover:from-green-100 hover:to-green-200 transition-all duration-300 hover-lift"
        >
        ...
        <Link
          ...
          className="group flex items-center justify-between gap-4 p-4 md:p-5 bg-white border-2 border-gray-200 rounded-xl hover:border-red-300 hover:bg-red-50 transition-all duration-300 hover-lift"
        >
          <div className="flex items-center gap-3 md:gap-4 flex-1">
